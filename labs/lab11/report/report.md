...
author: "Эллина Майзингер НПИбд-02-22"
...
1. Создайте каталог для программам лабораторной работы № 11, перейдите
...
![Файл lab11-1.asm](image/01.png){ #fig:001}

![Работа программы lab11-1.asm](image/02.png){ #fig:002}
...
![файл с запретом выполнения](image/03.png){ #fig:003}
...
![файл asm с разрешением на выполнение](image/04.png){ #fig:004}
...
![установка прав](image/05.png){ #fig:005}
...
![программа lab11-2.asm](image/06.png){ #fig:006}

![работа программы lab11-2.asm](image/07.png){ #fig:007}
